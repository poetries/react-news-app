      ...
      <div>
        <Row>
          ...
          <Col span={20} className='container'>
            ...
            <div>
							<PCNewsImageBlock count={20} type="guonei" width="100%" cartTitle="国内新闻" imageWidth="132px"/>
							<PCNewsImageBlock count={40} type="yule" width="100%" cartTitle="娱乐新闻" imageWidth="132px"/>
						</div>
          </Col>
          <Col span={2}></Col>
        </Row>
